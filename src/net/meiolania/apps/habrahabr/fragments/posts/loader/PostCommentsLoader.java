...
public class PostCommentsLoader extends AsyncTaskLoader<List<CommentEntry>> {
	private String url;
	...
	@Override
	public List<CommentEntry> loadInBackground() {
		CommentsApi commentsApi = new CommentsApi(HabrAuthApi.getInstance());
		return commentsApi.getPostComments(url);
	}
