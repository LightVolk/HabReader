...
public class FeedMainFragment extends SherlockFragment {
	...
	private void showActionBar() {
		...
		tab.setTag("posts");
		tab.setTabListener(new TabListener<FeedPostsFragment>(
				getSherlockActivity(), "posts", FeedPostsFragment.class));
		...
		tab.setTag("events");
		tab.setTabListener(new TabListener<FeedEventsFragment>(
				getSherlockActivity(), "events", FeedEventsFragment.class));
		actionBar.addTab(tab);
	}
